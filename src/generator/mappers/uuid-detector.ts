...
/**
 * Type-safe UUID default value structure
 */
interface UuidDefaultValue {
  readonly name: 'dbgenerated';
 ...
 */
function isUuidDefaultValue(value: unknown) {
  ...
  if (!candidate.args.every((arg): arg is string => typeof arg === 'string')) {
    return false;
  }
